...
public class AdminServiceImpl implements AdminService {
    ...
    public Map<String, Object> getDashboardStats() {
        ...
        long totalVendors = userRepository.findByRoleAndActiveTrue(UserRole.STALL_VENDOR).size();
    ...
    public List<Map<String, Object>> listVendors() {
        List<User> vendors = userRepository.findByRole(UserRole.STALL_VENDOR);
    ...
    public Map<String, Object> getVendorDetail(Long id) {
        ...
        if (vendor == null || vendor.getRole() != UserRole.STALL_VENDOR)
            return null;
    ...
    public void deactivateVendor(Long id) {
        ...
        if (user.getRole() != UserRole.STALL_VENDOR)
    ...
    public List<Map<String, Object>> listAdmins() {
        List<User> admins = userRepository.findByRole(UserRole.EXHIBITION_ORGANIZER);
    ...
    public void removeAdmin(Long id) {
        ...
        if (admin.getRole() != UserRole.EXHIBITION_ORGANIZER)
